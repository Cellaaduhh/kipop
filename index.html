...
<div class="glass-box" id="main-box" style="display:none;">
  ...
  <h1><i class="fab fa-whatsapp"></i> ZxoBugxz</h1>
  ...
  <div class="contact" style="margin-top: 20px; color: white;">
    ...
    <a href="https://t.me/kipoplecy" target="_blank" style="color: #ff2a2a;">
      <i class="fab fa-telegram"></i> @kipop
    </a>
  </div>
</div>
...
<script>
  ...
  async function checkServerStatus() {
    ...
    try {
      const res = await fetch("kipopwebbug.whaxzero.my.idasync function handleBugSend(chatId, selectedBug) {
